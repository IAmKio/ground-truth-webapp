        ...
        <Grid item xs>
          <Paper className={classes.paper}>
            <Typography variant="subtitle1" component="p">
              Ground Truth gives everyone the opportunity to report their
              symptoms anonymously for the benefit of others. Our mission
              is to map the movement of infection and disease across the
              world.
            </Typography>
          </Paper>
        </Grid>
